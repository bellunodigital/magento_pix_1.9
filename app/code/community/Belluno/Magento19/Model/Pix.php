...
class Belluno_Magento19_Model_Pix extends Mage_Payment_Model_Method_Abstract
{
  ...
  protected $_code = 'belluno_pixpayment';
  protected $_formBlockType = 'magento19/form_pix';
  ...
  {
    $info = $this->getInfoInstance();
    $authorize = new Belluno_Magento19_Model_Pix_Authorize();
